          ...
          <div class="page-content">
            ...
            <div class="mdl-card mdl-shadow--2dp main-container">
              ...
              <div class="mdl-card__supporting-text">
                ...
                <form method="get" action="<c:url value="./addRecensione"/>">
                    <input type="hidden" name="idMembro" id="membro" value="1">
                    <input type="hidden" name="idEvento" id="evento" value="${idE}">
                    <input class="mdl-textfield__input" type="text" name="commento" id="commento">
                    <label class="" for="commento">Commento</label>
                    <input class="mdl-textfield__input" type="text" name="voto" id="voto">
                    <label class="" for="voto">Voto</label>
